...
class RandomText extends React.Component {
...
} _defineProperty(RandomText, "propTypes", {
  text: p.string.isRequired, className: p.string, width: p.number.isRequired, // Sets font-size
  ...
  animationDuration: p.number.isRequired, animate: p.oneOf(['in', 'out']), homePage: p.bool
